...
##Roslyn
	...
	2.克隆初始化Roslyn的submodule,进入该目录执行以下两条命令:
		1.dotnet restore build\ToolsetPackages\BaseToolset.csproj
		2.dotnet restore Compiler.sln
...
##mcs
	...
	在mcs.proj目录下执行命令 dontet publish -c Release -r win7-x64 -f netcoreapp2.0 -o Roslyn
